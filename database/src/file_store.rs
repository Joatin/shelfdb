...
impl Store for FileStore {
    ...
    fn save_collection(&self, schema: &Schema, collection: &Collection) -> Pin<Box<dyn Future<Output=Result<(), Error>> + Send>> {
        ...
        async move {
            ...
            info!(logger, "Saved database.collection \"{}\"", collection_name; "schema_id" => schema_id.to_string(), "schema_name" => &schema_name, "id" => collection_id.to_string(), "name" => &collection_name);
